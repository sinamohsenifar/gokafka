...
How this wiki is organized, so new notes stay consistent and the [[Dashboard]] Bases keep working.
...
- **Templates** (`meta/templates/`) — `page.md`, `adr.md`. New note → Templates: Insert.
