...
1. Builds the [[architecture/cluster-coordinator|Cluster]] from `cfg.Brokers` + security.
...
## Related
[[architecture/overview]] · [[architecture/transport]] · [[architecture/cluster-coordinator]] · [[architecture/wire-protocol]] · [[protocol/version-negotiation]] · [[compatibility/redpanda]] · [[protocol/api-coverage]]
